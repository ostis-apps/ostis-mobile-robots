...
{
public:
  static inline ScKeynode const action_coordinate_mobile_robot{
      "action_coordinate_mobile_robot",
      ScType::ConstNodeClass};
  static inline ScKeynode const action_interpreter_mobile_robot{
      "action_interpreter_mobile_robot",
      ScType::ConstNodeClass};
  ...
  static inline ScKeynode const nrel_total_obstacle_wait_time{
