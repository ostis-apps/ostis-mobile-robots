...
class Keynodes:
    ACTION_COORDINATE_MOBILE_ROBOT = "action_coordinate_mobile_robot"


class MobileRobotCoordinationAgent(ScAgent):
    def __init__(self):
    ...
    def check_initiation_condition(
        ...
        # агента интерпретации состояний мобильного робота, для дальнейшего вызова on_event
    ...
    def on_event(
        ...
        action_class_addr = ScKeynodes.resolve(Keynodes.ACTION_COORDINATE_MOBILE_ROBOT, sc_type=sc_type.CONST_NODE_CLASS)
